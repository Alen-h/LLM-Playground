  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-4 text-center">LLM Playground</h1>
        
        {/* GitHub Repository Link */}
        <div className="text-center mb-8">
          <p className="text-sm text-gray-600 mb-2">
            This project is totally open-sourced, please feel free to browse.
          </p>
          <a
            href="https://github.com/Alen-h/LLM-Playground"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 rounded-md transition-colors duration-200 text-sm font-medium shadow-md hover:shadow-lg"
          >
